...
export interface Manifest { fetched_at: string; window_days: number; counts: Record<string, number>; brawl?: { fetched_at: string; window_days: number }; validation_sets?: ValidationSetRef[] }
